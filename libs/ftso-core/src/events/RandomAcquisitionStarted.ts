...
export class RandomAcquisitionStarted extends RawEventConstructible {
   ...
   static fromRawEvent(event: any): RandomAcquisitionStarted {
      return decodeEvent<RandomAcquisitionStarted>(CONTRACTS.FlareSystemManager.name, RandomAcquisitionStarted.eventName, event, (data: any) => new RandomAcquisitionStarted(data))
   }
