...
export namespace PartialRewardOffer {
    ...
    */
   export function fromInflationRewardOfferedEquallyDistributed(inflationRewardOffer: InflationRewardsOffered): IPartialRewardOffer[] {
    ...
    * @param rewardOffer 
    */
   export function splitToVotingRoundsEqually(startVotingRoundId: number, endVotingRoundId: number, rewardOffer: IPartialRewardOffer): IPartialRewardOffer[] {
