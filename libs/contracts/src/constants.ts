...
export const COSTON2_CONTRACTS: NetworkContractAddresses = {
  ...
  FlareSystemsCalculator: { name: "FlareSystemsCalculator", address: "0x93F4C0b43A221Cf0a57faa882Df5E3F6CAa5Aca8" },
...
export const SONGBIRD_CONTRACTS: NetworkContractAddresses = {
  ...
  VoterRegistry: { name: "VoterRegistry", address: "0xd23FAE88c09e6A77dD9eFcc29D6bBC55D2e74310" },
  FtsoMerkleStructs: { name: "FtsoMerkleStructs", address: "" },
  ProtocolMerkleStructs: { name: "ProtocolMerkleStructs", address: "" },
...
export const FLARE_CONTRACTS: NetworkContractAddresses = {
  ...
  VoterRegistry: { name: "VoterRegistry", address: "0xA480457953Af3583E54DCd630b219353B8FC9Af7" },
  FtsoMerkleStructs: { name: "FtsoMerkleStructs", address: "" },
  ProtocolMerkleStructs: { name: "ProtocolMerkleStructs", address: "" },
...
const contracts = () => {
  ...
  switch (network) {
    ...
    case "from-env": {
      ...
      if (!process.env.FTSO_CA_FDC_HUB_ADDRESS || !isValidContractAddress(process.env.FTSO_CA_FDC_HUB_ADDRESS))
