...
import { RewardClaim, MedianCalculationResult, RewardOffered, VoterRewarding } from "../lib/voting-interfaces";
import { ZERO_ADDRESS, feedId, toBN } from "../lib/voting-utils";
