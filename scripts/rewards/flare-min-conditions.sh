...
export FROM_REWARD_EPOCH_ID=246
node dist/apps/ftso-reward-calculation-process/apps/ftso-reward-calculation-process/src/main.js ftso-reward-calculation-process -f -r $FROM_REWARD_EPOCH_ID
