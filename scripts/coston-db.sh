...
node dist/apps/ftso-reward-calculation-process/apps/ftso-reward-calculation-process/src/main.js ftso-reward-calculation-process -r 2640 -i -g -o -c -a -b 40 -w 10 -d $FROM_REWARD_EPOCH_ID -m 10000
