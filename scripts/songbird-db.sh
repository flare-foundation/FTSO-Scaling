...
export FROM_REWARD_EPOCH_ID=184
node dist/apps/ftso-reward-calculation-process/apps/ftso-reward-calculation-process/src/main.js ftso-reward-calculation-process -i -a -c -b 100 -w 10 -d $FROM_REWARD_EPOCH_ID -m 10000
