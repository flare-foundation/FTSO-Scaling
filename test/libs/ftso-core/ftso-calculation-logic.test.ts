...
describe(`FTSO calculation logic (${getTestFile(__filename)})`, () => {
  describe("calculateMedian", () => {
    ...
    describe("when total weight is odd", () => {
      ...
      it("computes the weighted median, quartiles, and participating weight", () => {
  ...
  describe("sortFeedWithValuesToCanonicalOrder", () => {
    it("orders feeds by isInflation, then flrValue desc, then feed id", () => {
  ...
  describe("rewardEpochFeedSequence", () => {
    it("produces the canonical feed order for a single inflation offer plus community offers", () => {
    ...
    it("merges feeds that appear in multiple inflation offers without duplicates", () => {
      const rewardOffers: RewardOffers = {
        inflationOffers: [
          {
            rewardEpochId: 1,
    ...
    it("deduplicates community offers that target the same feed", () => {
      const rewardOffers: RewardOffers = {
        inflationOffers: [],
        rewardOffers: [
          {
