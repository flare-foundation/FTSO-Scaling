...
describe(`PartialRewardOffer (${getTestFile(__filename)})`, () => {
  ...
  it("converts RewardsOffered to PartialRewardOffer", () => {
  ...
  it("converts InflationRewardsOffered to evenly-distributed PartialRewardOffers", () => {
  ...
  it("splits a partial offer equally across voting rounds", () => {
    const partialRewardOffer = PartialRewardOffer.fromRewardOffered(rewardsOffered);
