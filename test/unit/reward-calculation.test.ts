...
// import { applyPenalty, mergeClaims } from "../../libs/ftso-core/src/reward-calculation";
...
//     const mergedClaims = mergeClaims(mergePriceEpochId, unmergedClaims);
...
//         priceEpochId: 1,
//       };
//       const [resultClaim, resultPenalty] = applyPenalty(claim, penalty);
